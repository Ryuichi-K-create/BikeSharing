...
図\ref{fig:data_split}に、実際の時系列データにおける分割の様子を示す。

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{output/data_split.png}
    \caption{時系列順によるデータ分割 (Train: 60\%, Validation: 20\%, Test: 20\%)}
